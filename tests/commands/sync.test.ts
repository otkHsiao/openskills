...
// Helper function to escape YAML string values (mirrors sync.ts implementation)
...
describe('Roo command sync (.roo/command/)', () => {
  ...
  describe('generateRooCommandContent', () => {
    ...
    it('should include openskills marker', () => {
      const skill: Skill = {
        name: 'test',
      ...
      expect(content.includes(OPENSKILLS_MARKER)).toBe(true);
    });
    ...
    it('should escape quotes in description', () => {
      ...
      expect(content).toContain('description: "A skill with \\"quotes\\" in description"');
      expect(content).not.toContain('description: "A skill with "quotes" in description"');
    });
  ...
  describe('Roo command directory creation', () => {
    it('should create .roo/commands/ directory structure', () => {
      const rooCommandDir = join(testTempDir, '.roo', 'commands');
    ...
    it('should write skill command files to .roo/commands/', () => {
      const rooCommandDir = join(testTempDir, '.roo', 'commands');
      mkdirSync(rooCommandDir, { recursive: true });
